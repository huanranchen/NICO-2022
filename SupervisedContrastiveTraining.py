...
class SupervisedContrast():
    def __init__(self, loader, num_classes=60):
        ...
        self.student = models.resnet50(num_classes=60).to(self.device)
        self.teacher = models.resnet50(num_classes=60).to(self.device)
